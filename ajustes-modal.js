...
(function () {
    ...
    overlay.innerHTML =
      '<div class="ajustes-modal" role="dialog" aria-modal="true" aria-labelledby="ajustesTitulo">' +
        '<div class="ajustes-modal__header">' +
          '<h2 class="ajustes-modal__title" id="ajustesTitulo">Ajustes</h2>' +
          '<button type="button" class="ajustes-modal__close" aria-label="Cerrar">' +
        ...
        '<div class="ajustes-modal__body">' +
          '<nav class="ajustes-modal__tabs">' +
            tabBtn('cuenta', ICONS.cuenta, 'Cuenta', true) +
            tabBtn('apariencia', ICONS.apariencia, 'Apariencia') +
            tabBtn('preferencias', ICONS.preferencias, 'Preferencias') +
            tabBtn('privacidad', ICONS.privacidad, 'Privacidad') +
          '</nav>' +
  ...
  function tabBtn(key, icon, label, active) {
  ...
  function seccionCuenta() {
    return (
      '<section class="ajustes-section" data-section="cuenta" data-active="true">' +
        '<div>' +
          '<p class="ajustes-section__title">Perfil</p>' +
          '<div class="ajustes-field" style="margin-top:10px">' +
            '<label for="ajNombre">Nombre para mostrar</label>' +
            '<input type="text" id="ajNombre" class="ajustes-input" placeholder="Tu nombre" maxlength="60">' +
          '</div>' +
        '</div>' +
        ...
        '</div>' +
        '<div>' +
          '<button type="button" class="ajustes-btn ajustes-btn--primario" id="ajGuardarPerfil">Guardar cambios</button>' +
        '</div>' +
        '<div class="ajustes-status" id="ajCuentaStatus"></div>' +
        '<hr class="ajustes-divider">' +
        '<div>' +
          '<p class="ajustes-section__title">Información personal</p>' +
          '<div class="ajustes-field" style="margin-top:10px">' +
            '<label for="ajTelefono">Teléfono (opcional)</label>' +
            '<input type="tel" id="ajTelefono" class="ajustes-input" placeholder="+507 6000-0000">' +
          '</div>' +
          '<div class="ajustes-field" style="margin-top:10px">' +
            '<label for="ajCiudad">Ciudad</label>' +
            '<input type="text" id="ajCiudad" class="ajustes-input" placeholder="Ej. David, Panamá">' +
          '</div>' +
        '</div>' +
      '</section>'
    );
    ...
    guardarBtn.addEventListener('click', function () {
      ...
      window.recoSupabase.auth.updateUser({ data: { nombre: nuevoNombre } })
        .then(function (res) {
          ...
          if (res.error) {
            mostrarStatus(statusEl, 'error', 'No se pudo guardar: ' + res.error.message);
            return;
          }
          mostrarStatus(statusEl, 'ok', 'Cambios guardados.');
        })
        .catch(function () {
          guardarBtn.disabled = false;
          guardarBtn.textContent = 'Guardar cambios';
          mostrarStatus(statusEl, 'error', 'No se pudo conectar. Intenta de nuevo.');
        });
    });
  }
      ...
      '<section class="ajustes-section" data-section="apariencia">' +
        '<div class="ajustes-row">' +
          '<div class="ajustes-row__text">' +
            '<p class="ajustes-row__label">Tema</p>' +
            '<p class="ajustes-row__desc">Elige cómo se ve RECO+ en este dispositivo.</p>' +
          '</div>' +
          '<div class="ajustes-segmented" id="ajTemaSeg">' +
            '<button type="button" class="ajustes-segmented__opt" data-valor="light">Claro</button>' +
            '<button type="button" class="ajustes-segmented__opt" data-valor="dark">Oscuro</button>' +
          '</div>' +
        '</div>' +
        '<hr class="ajustes-divider">' +
        '<div class="ajustes-row">' +
          '<div class="ajustes-row__text">' +
            '<p class="ajustes-row__label">Tamaño de fuente</p>' +
            '<p class="ajustes-row__desc">Ajusta el tamaño del texto en todo el sitio.</p>' +
          '</div>' +
  ...
  function seccionPreferencias() {
    return (
      '<section class="ajustes-section" data-section="preferencias">' +
        '<div class="ajustes-row">' +
          '<div class="ajustes-row__text">' +
            '<p class="ajustes-row__label">Idioma</p>' +
            '<p class="ajustes-row__desc">Idioma de la interfaz de RECO+.</p>' +
          '</div>' +
        ...
        '<div class="ajustes-row">' +
          '<div class="ajustes-row__text">' +
            '<p class="ajustes-row__label">Notificaciones</p>' +
            '<p class="ajustes-row__desc">Avisos sobre solicitudes, mensajes y novedades.</p>' +
          '</div>' +
        ...
        '<div class="ajustes-row">' +
          '<div class="ajustes-row__text">' +
            '<p class="ajustes-row__label">Ubicación</p>' +
            '<p class="ajustes-row__desc">Permite sugerir puntos de reciclaje cercanos a ti.</p>' +
          '</div>' +
          '<button type="button" class="ajustes-switch" id="ajUbicSwitch" data-on="false"><span class="ajustes-switch__knob"></span></button>' +
        '</div>' +
        '<div class="ajustes-row">' +
          '<div class="ajustes-row__text">' +
            '<p class="ajustes-row__label">Cámara</p>' +
            '<p class="ajustes-row__desc">Necesaria para el escáner de materiales.</p>' +
          '</div>' +
  ...
  function seccionPrivacidad() {
    return (
      '<section class="ajustes-section" data-section="privacidad">' +
        '<div>' +
          '<p class="ajustes-section__title">Sesión</p>' +
          '<div class="ajustes-row" style="margin-top:10px">' +
            '<div class="ajustes-row__text">' +
              '<p class="ajustes-row__label">Cerrar sesión</p>' +
              '<p class="ajustes-row__desc">Saldrás de tu cuenta en este dispositivo.</p>' +
            '</div>' +
            '<button type="button" class="ajustes-btn" id="ajCerrarSesion">Cerrar sesión</button>' +
          '</div>' +
        '</div>' +
        '<div class="ajustes-danger-zone">' +
          '<div>' +
            '<p class="ajustes-row__label" style="color:#c23a2a">Eliminar cuenta</p>' +
            '<p class="ajustes-row__desc">Esta acción es permanente. Se eliminarán tus datos de RECO+ y no podrás deshacerla.</p>' +
          '</div>' +
          '<button type="button" class="ajustes-btn ajustes-btn--peligro" id="ajEliminarCuenta">Eliminar mi cuenta</button>' +
        '</div>' +
  ...
  function wireSeccionPrivacidad(overlay) {
    ...
    eliminarBtn.addEventListener('click', function () {
      if (eliminarBtn.getAttribute('data-confirmando') !== 'true') {
        ...
        eliminarBtn.textContent = '¿Confirmar? Toca de nuevo';
        setTimeout(function () {
          eliminarBtn.setAttribute('data-confirmando', 'false');
          eliminarBtn.textContent = 'Eliminar mi cuenta';
        }, 4000);
        return;
      }
      mostrarStatus(statusEl, 'error', 'Para eliminar tu cuenta, escríbenos a soporte.recoplus@gmail.com. (Requiere verificación desde el servidor.)');
      eliminarBtn.setAttribute('data-confirmando', 'false');
      eliminarBtn.textContent = 'Eliminar mi cuenta';
    });
  }
