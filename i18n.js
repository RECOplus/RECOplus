...
const translations = {
  es: {
    ...
    "scannerdemo.subtitle":       "Apunta la cámara: verás una vista previa en vivo. Cuando el objeto esté centrado, confirma con IA para tu resultado final.",
    ...
    "scannerdemo.preview.hint": "Orientativo mientras apuntas. Para el resultado final, usa \"Confirmar con IA\".",
  ...
  en: {
    ...
    "scannerdemo.subtitle":       "Point the camera: you'll see a live preview. Once the object is centered, confirm with AI for your final result.",
    ...
    "scannerdemo.preview.hint": "A rough guide while you aim. For the final result, use \"Confirm with AI\".",
