...
(function() {
            /* ── Todo lo que vaya a reciclar.html (fichas de material) debe
               apuntar siempre al deploy de Vercel, nunca a GitHub Pages,
               porque el escáner IA (/api/classify) solo vive en Vercel. ── */
            var RECICLAR_BASE_URL = 'https://r-ec-o-plus-final.vercel.app/reciclar.html';
            ...
            /* ── Materiales reciclables (las 18 categorías de reciclar.html) ──
               Cada entrada apunta directo a la ficha real del material
               en reciclar.html (badge, dónde llevarlo, cómo prepararlo,
               alertas de seguridad, etc. — ver reciclar-material-info.js)
               en vez de solo a la guía general o a donar.html. */
            var MATERIALS = [
                { q: 'plástico',         url: RECICLAR_BASE_URL + '?material=plastico',        icon: '♻️', descEs: 'Ficha de reciclaje — Plástico',        descEn: 'Recycling info — Plastic' },
                { q: 'plastic',          url: RECICLAR_BASE_URL + '?material=plastico',        icon: '♻️', descEs: 'Ficha de reciclaje — Plástico',        descEn: 'Recycling info — Plastic' },
                { q: 'vidrio',           url: RECICLAR_BASE_URL + '?material=vidrio',          icon: '🫙', descEs: 'Ficha de reciclaje — Vidrio',          descEn: 'Recycling info — Glass' },
                { q: 'glass',            url: RECICLAR_BASE_URL + '?material=vidrio',          icon: '🫙', descEs: 'Ficha de reciclaje — Vidrio',          descEn: 'Recycling info — Glass' },
                { q: 'papel',            url: RECICLAR_BASE_URL + '?material=papel',           icon: '📄', descEs: 'Ficha de reciclaje — Papel',           descEn: 'Recycling info — Paper' },
                { q: 'paper',            url: RECICLAR_BASE_URL + '?material=papel',           icon: '📄', descEs: 'Ficha de reciclaje — Papel',           descEn: 'Recycling info — Paper' },
                { q: 'cartón',           url: RECICLAR_BASE_URL + '?material=carton',          icon: '📦', descEs: 'Ficha de reciclaje — Cartón',          descEn: 'Recycling info — Cardboard' },
                { q: 'carton',           url: RECICLAR_BASE_URL + '?material=carton',          icon: '📦', descEs: 'Ficha de reciclaje — Cartón',          descEn: 'Recycling info — Cardboard' },
                { q: 'cardboard',        url: RECICLAR_BASE_URL + '?material=carton',          icon: '📦', descEs: 'Ficha de reciclaje — Cartón',          descEn: 'Recycling info — Cardboard' },
                { q: 'metal',            url: RECICLAR_BASE_URL + '?material=metal',           icon: '🔩', descEs: 'Ficha de reciclaje — Metal',           descEn: 'Recycling info — Metal' },
                { q: 'ropa',             url: RECICLAR_BASE_URL + '?material=ropa',            icon: '👗', descEs: 'Ficha de reciclaje — Ropa',            descEn: 'Recycling info — Clothing' },
                { q: 'clothes',          url: RECICLAR_BASE_URL + '?material=ropa',            icon: '👗', descEs: 'Ficha de reciclaje — Ropa',            descEn: 'Recycling info — Clothing' },
                { q: 'clothing',         url: RECICLAR_BASE_URL + '?material=ropa',            icon: '👗', descEs: 'Ficha de reciclaje — Ropa',            descEn: 'Recycling info — Clothing' },
                { q: 'electronico',      url: RECICLAR_BASE_URL + '?material=electronicos',    icon: '💻', descEs: 'Ficha de reciclaje — Electrónicos',    descEn: 'Recycling info — Electronics' },
                { q: 'electronic',       url: RECICLAR_BASE_URL + '?material=electronicos',    icon: '💻', descEs: 'Ficha de reciclaje — Electrónicos',    descEn: 'Recycling info — Electronics' },
                { q: 'celular',          url: RECICLAR_BASE_URL + '?material=celulares',       icon: '📱', descEs: 'Ficha de reciclaje — Celulares',       descEn: 'Recycling info — Phones' },
                { q: 'phone',            url: RECICLAR_BASE_URL + '?material=celulares',       icon: '📱', descEs: 'Ficha de reciclaje — Celulares',       descEn: 'Recycling info — Phones' },
                { q: 'bateria',          url: RECICLAR_BASE_URL + '?material=baterias',        icon: '🔋', descEs: 'Ficha de reciclaje — Baterías',        descEn: 'Recycling info — Batteries' },
                { q: 'battery',          url: RECICLAR_BASE_URL + '?material=baterias',        icon: '🔋', descEs: 'Ficha de reciclaje — Baterías',        descEn: 'Recycling info — Batteries' },
                { q: 'pila',             url: RECICLAR_BASE_URL + '?material=baterias',        icon: '🔋', descEs: 'Ficha de reciclaje — Baterías',        descEn: 'Recycling info — Batteries' },
                { q: 'bombillo',         url: RECICLAR_BASE_URL + '?material=bombillos',       icon: '💡', descEs: 'Ficha de reciclaje — Bombillos',       descEn: 'Recycling info — Light bulbs' },
                { q: 'light bulb',       url: RECICLAR_BASE_URL + '?material=bombillos',       icon: '💡', descEs: 'Ficha de reciclaje — Bombillos',       descEn: 'Recycling info — Light bulbs' },
                { q: 'foco',             url: RECICLAR_BASE_URL + '?material=bombillos',       icon: '💡', descEs: 'Ficha de reciclaje — Bombillos',       descEn: 'Recycling info — Light bulbs' },
                { q: 'mueble',           url: RECICLAR_BASE_URL + '?material=muebles',         icon: '🪑', descEs: 'Ficha de reciclaje — Muebles',         descEn: 'Recycling info — Furniture' },
                { q: 'furniture',        url: RECICLAR_BASE_URL + '?material=muebles',         icon: '🪑', descEs: 'Ficha de reciclaje — Muebles',         descEn: 'Recycling info — Furniture' },
                { q: 'juguete',          url: RECICLAR_BASE_URL + '?material=juguetes',        icon: '🧸', descEs: 'Ficha de reciclaje — Juguetes',        descEn: 'Recycling info — Toys' },
                { q: 'toy',              url: RECICLAR_BASE_URL + '?material=juguetes',        icon: '🧸', descEs: 'Ficha de reciclaje — Juguetes',        descEn: 'Recycling info — Toys' },
                { q: 'libro',            url: RECICLAR_BASE_URL + '?material=libros',          icon: '📚', descEs: 'Ficha de reciclaje — Libros',          descEn: 'Recycling info — Books' },
                { q: 'book',             url: RECICLAR_BASE_URL + '?material=libros',          icon: '📚', descEs: 'Ficha de reciclaje — Libros',          descEn: 'Recycling info — Books' },
                { q: 'tetra pak',        url: RECICLAR_BASE_URL + '?material=tetrapak',        icon: '🧃', descEs: 'Ficha de reciclaje — Tetra Pak',       descEn: 'Recycling info — Tetra Pak' },
                { q: 'tetrapak',         url: RECICLAR_BASE_URL + '?material=tetrapak',        icon: '🧃', descEs: 'Ficha de reciclaje — Tetra Pak',       descEn: 'Recycling info — Tetra Pak' },
                { q: 'aceite',           url: RECICLAR_BASE_URL + '?material=aceite',          icon: '🋖', descEs: 'Ficha de reciclaje — Aceite de cocina', descEn: 'Recycling info — Cooking oil' },
                { q: 'oil',              url: RECICLAR_BASE_URL + '?material=aceite',          icon: '🋖', descEs: 'Ficha de reciclaje — Aceite de cocina', descEn: 'Recycling info — Cooking oil' },
                { q: 'tela',             url: RECICLAR_BASE_URL + '?material=tela',            icon: '🧵', descEs: 'Ficha de reciclaje — Tela',            descEn: 'Recycling info — Fabric' },
                { q: 'fabric',           url: RECICLAR_BASE_URL + '?material=tela',            icon: '🧵', descEs: 'Ficha de reciclaje — Tela',            descEn: 'Recycling info — Fabric' },
                { q: 'cuero',            url: RECICLAR_BASE_URL + '?material=cuero',           icon: '🧥', descEs: 'Ficha de reciclaje — Cuero',           descEn: 'Recycling info — Leather' },
                { q: 'leather',          url: RECICLAR_BASE_URL + '?material=cuero',           icon: '🧥', descEs: 'Ficha de reciclaje — Cuero',           descEn: 'Recycling info — Leather' },
                { q: 'utiles escolares', url: RECICLAR_BASE_URL + '?material=utilesescolares', icon: '✏️', descEs: 'Ficha de reciclaje — Útiles escolares', descEn: 'Recycling info — School supplies' },
                { q: 'school supplies',  url: RECICLAR_BASE_URL + '?material=utilesescolares', icon: '✏️', descEs: 'Ficha de reciclaje — Útiles escolares', descEn: 'Recycling info — School supplies' },
            ];
